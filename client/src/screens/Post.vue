...
export default {
  ...
  components: { Comment, Vote, SubInfo, CreateButton },
  ...
  methods: {
    ...
    createComment() {
      postServices.addComment(this.id, this.newCommentContent)
        .then((response) => {
