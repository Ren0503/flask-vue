<template lang="html">
  <nav>
    ...
    <div class="dropdown">
      <button class="dropbtn">Subs</button>
      <div class="dropdown-content">
        <router-link
          v-for="sub in $store.state.subscribedSubs"
          :key="sub.permalink"
          :to="{ name: 'Sub', params: {name: subvue.permalink} }"
          >{{ sub.name }}</router-link>
        <router-link class="create-sub" :to="{ name: 'CreateSub' }">Create a Subvue</router-link>
      </div>
    </div>
