...
class User(Document):
    ...
    subscribed = ListField(ReferenceField("Sub"))
    ...
    def to_public_json(self):
        ...
        data = {
            ...
            "subscribed": [sub.to_public_json() for sub in self.subscribed],
...
class Post(Document):
    ...
    sub = ReferenceField(Sub, required=True, reverse_delete_rule=CASCADE)
